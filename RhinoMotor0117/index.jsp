	...
	<div class="wrapper index">
		...
		<div class="content">
			<div class="index_page">
				<div class="banner">
			      ...
			      <div class="banner_container">        
			        ...
			        <div class="swiper-wrapper">
			        	...
			        	<c:forEach items="${adList}" var="result" varStatus="status">
			        	<div class="swiper-slide">
			        		<a href="${result.adlink}">
			        			<div class="word white">
			        				<div class="big">${result.adname}</div>
			        				<div class="small">${result.adname}</div>
			        			</div>
			        			<div class="pic"><img src="ad_TableAction.do?method=showTempImage&tempkey=${result.adpic}" /></div>
			        		</a>
			        	</div>
			        	</c:forEach>
			        	</logic:present>
			    ...
			    <div class="cars_area">
			    	<div class="cars_areain">
			    		<div class="title">CARS</div>
						<div class="box">
						<logic:present name="productDbList" scope="session">
							<c:forEach items="${productDbList}" var="result" varStatus="status">
							<div class="n">
								<a href="${pageContext.request.contextPath}${carsUrl}&id=${result.id}">
			    ...
			    <div class="service_area">
			    	<div class="btn"><a href="${pageContext.request.contextPath}/index.do?method=service">SERVICE</a></div>
			    </div>
			    <div class="press_area">
					<div class="press_areain">
